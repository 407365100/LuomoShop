...
package com.luomo.shopping.widget.zxing.view;
...
public final class ViewfinderView extends View {
	 ...
	 * 刷新界面的时间
	 */
	private static final long ANIMATION_DELAY = 10L;//动画延时
	private static final int OPAQUE = 0xFF;//不透明的
	/**
	 * 四个绿色边角对应的长度
	 */
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		resultPointColor = resources.getColor(R.color.color_c0ffff00);
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawText(getResources().getString(R.string.scan_hint), frame.left, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
