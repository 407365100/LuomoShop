package com.luomo.shopping.widget.pulltorefresh;
...
/**
 * The footer view for {@link XListView}
 * @author markmjw
 * @date 2013-10-08
 */
...
//    private ImageView mHintImage;
    ...
    private void initView(Context context) {
        mLayout = LayoutInflater.from(context).inflate(R.layout.pull_refresh_footer, null);
